...
public class MaintenanceTaskOfferRequirementProvider implements CassandraOfferRequirementProvider {

    private static final Logger LOGGER = LoggerFactory.getLogger(MaintenanceTaskOfferRequirementProvider.class);
    ...
    @Inject
    public MaintenanceTaskOfferRequirementProvider(
    ...
    private OfferRequirement getCreateOfferRequirement(Protos.TaskInfo taskInfo) {
        final PlacementStrategy placementStrategy =
                PlacementStrategyManager.getPlacementStrategyForMaintenanceTask(cassandraTasks);
        final List<Protos.SlaveID> agentsToAvoid = placementStrategy.getAgentsToAvoid(taskInfo);
        final List<Protos.SlaveID> agentsToColocate = placementStrategy.getAgentsToColocate(taskInfo);
    ...
    private OfferRequirement getExistingOfferRequirement(Protos.TaskInfo taskInfo) {
